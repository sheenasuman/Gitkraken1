...
const GitKrakenHero = () => {
  return (
    ...
    <div className="relative w-full h-[600px] lg:h-[600px] l-[891] t-[-276]">
          <Image
        ...
        <div className="relative w-full h-[300px] lg:h-[200px] bottom-100px left-100px">
          <Image
        ...
        <div className="bg-[#1A1A1A] p-6 rounded-xl border border-[#2A2A2A] text-center">
          ...
          <div className="flex flex-wrap justify-center gap-12 text-sm">            
            <div className="flex flex-col items-center">
               <Image src="/images/desk.svg" alt="image" width={53} height={30} className="text-teal-400 text-2xl mb-2" />
            ...
            <div className="flex flex-col items-center">
              <Image src="/images/vs.svg" alt="image" width={33} height={30}  className="text-blue-400 text-2xl mb-2" />
            ...
            <div className="flex flex-col items-center">
              <Image src="/images/terminal.svg" alt="image" width={43} height={30} className="text-green-400 text-2xl mb-2" />
            ...
            <div className="flex flex-col items-center">
              <Image src="/images/BE.svg" alt="image" width={43} height={30} className="text-purple-400 text-2xl mb-2" />
